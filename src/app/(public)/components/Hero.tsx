  ...
  return (
    ...
    >
      ...
      <div className="container-guarida z-10 flex flex-col justify-center h-full  text-guarida-sky space-y-16">
        ...
        {/* Título principal */}
        <h1 className="font-spiritual text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-light leading-none bg-linear-to-b from-guarida-sky via-guarida-sky to-transparent via-60% uppercase bg-clip-text text-transparent">
          La Guarida del Alma
        </h1>

        {/* Bajada */}
        <p className="hidden sm:block text-lg font-light font-spiritual uppercase text-white tracking-wide mx-auto leading-relaxed mt-auto">
          Un espacio para encontrarte con vos mismo,
          <br /> sanar desde la raíz y vivir con plenitud.
        </p>
